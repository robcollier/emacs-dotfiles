;; DESCRIPTION: Rob Colliers  settings
;; Borrowed from topfunky (still uses topfunky folder)
...
;;; Small eye candy hacks
;; Frame transparency

(setq transparency-level 95) (set-frame-parameter nil 'alpha
transparency-level) (add-hook 'after-make-frame-functions (lambda
(selected-frame) (set-frame-parameter selected-frame 'alpha
transparency-level)))

;; Initialize Auto pair mode
(require 'autopair)
(autopair-global-mode)

;; Custom Mappings
;; Set Ctrl - ' to Set Mark
